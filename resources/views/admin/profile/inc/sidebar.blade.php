<div class="card">
    ...
    <ul class="list-group">
        <li style="margin-bottom: 5px"><a href="{{ route('admin.profile') }}"
                class="btn btn-primary btn-sm btn-block">Home</a>
        </li>
        <li style="margin-bottom: 5px"><a href="{{ route('admin.image') }}"
                class="btn btn-primary btn-sm btn-block">Update
                Image</a></li>
        <li style="margin-bottom: 5px"><a href="{{ route('admin.password') }}"
                class="btn btn-primary btn-sm btn-block">Update
                Password</a></li>
        <li>
