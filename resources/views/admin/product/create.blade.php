...
@section('admin_content')
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            <div class="card p-3">
                <h6 class="card-header card-body-title m-0">Add Product</h6>
                <div class="card-body">
                        ...
                        <div class="row row-sm">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2-show-search" name="brand_id"
                                        ...
                                        @foreach ($brands as $brand)
                                            <option value="{{ $brand->id }}">{{ ucwords($brand->brand_name_en) }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('brand_id')
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="short_description_en" id="summernote" cols="30" rows="10"></textarea>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Short Description</label>
                                    <textarea name="short_description_bn" id="summernote2" cols="30" rows="10"></textarea>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="long_description_en" id="summernote3" cols="30" rows="10"></textarea>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Long Description</label>
                                    <textarea name="long_description_bn" id="summernote4" cols="30" rows="10"></textarea>
