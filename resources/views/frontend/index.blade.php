    ...
    <div class="row">
                        ...
                        <div class="item">
                            <div class="products">
                                <div class="hot-deal-wrapper">
                                    <div class="image">
                                        <img src="{{ $hot_deal->product_thumbnail }}" alt="">
                                    </div>
                                ...
                                <div class="product-info text-left m-t-20">
                                    <h3 class="name"><a href="detail.html">{{ $hot_deal->product_name_en }}</a></h3>
                    ...
                    <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                        ...
                        <div class="item">
                            <div class="products special-product">
                                @foreach ($special_offer as $special_offer)
                                    <div class="product">
                                            ...
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                <img src="{{ $special_offer->product_thumbnail }}"
                                                                    alt="">
                                                            </a>
                                                        </div><!-- /.image -->
                                                    </div><!-- /.product-image -->
                                                ...
                                                <div class="col col-xs-7">
                                                    <div class="product-info">
                                                        <h3 class="name"><a
                                                                href="#">{{ $special_offer->product_name_en }}</a>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price">
                                                            <span class="price">$
                                                                {{ $special_offer->selling_price }}</span>
                                                        </div><!-- /.product-price -->
                                                    </div>
                                                </div><!-- /.col -->
            ...
            <div class="sidebar-widget outer-bottom-small wow fadeInUp">
                ...
                <div class="sidebar-widget-body outer-top-xs">
                    <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                        ...
                        <div class="item">
                            <div class="products special-product">
                                @foreach ($special_deals as $special_deals)
                                    <div class="product">
                                        <div class="product-micro">
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                <img src="{{ $special_deals->product_thumbnail }}"
                                                                    alt="">
                                                            </a>
                                                        </div><!-- /.image -->
                                                    </div><!-- /.product-image -->
                                                ...
                                                <div class="col col-xs-7">
                                                    <div class="product-info">
                                                        <h3 class="name"><a
                                                                href="#">{{ $special_deals->product_name_en }}</a>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price">
                                                            <span class="price">{{ $special_deals->selling_price }}</span>
                                                        </div><!-- /.product-price -->
                                                    </div>
                                                </div><!-- /.col -->
                                            </div><!-- /.product-micro-row -->
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                    ...
                    <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                        ...
                        @foreach ($categories as $category)
                            <li><a data-transition-type="backSlide" href="#category{{ $category->id }}"
                                    data-toggle="tab">{{ ucwords($category->category_name_en) }}</a></li>
                        @endforeach
                    </ul><!-- /.nav-tabs -->
                </div>
                                        ...
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a
                                                            href="{{ route('single.product', $product->id) }}">{{ $product->product_name_en }}</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                        ...
                        <div class="tab-pane" id="category{{ $category->id }}">
                            <div class="product-slider">
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                                    @php
                                        $categoryWishProduct = App\Models\Product::where('category_id', $category->id)
                                            ->orderby('id', 'desc')
                                            ->get();
                                    @endphp
                                    @forelse ($categoryWishProduct as $product)
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
            ...
            <section class="section wow fadeInUp new-arriavls">
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                    @foreach ($skip_category_1 as $item)
                        <div class="item item-carousel">
                            <div class="products">
