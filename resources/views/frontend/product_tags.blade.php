            ...
            <div class='row'>
                                    ...
                                    <div class="accordion">
                                        @foreach ($categories as $category)
                                            <div class="accordion-group">
                                                ...
                                                <div class="accordion-body collapse" id="category{{ $category->id }}"
                                                    style="height: 0px;">
                                                    <div class="accordion-inner">
                                                        ...
                                                        <ul>
                                                            @foreach ($subcategories as $subcategory)
                                                                <li><a
                                                                        href="#">{{ $subcategory->subcategory_name_en }}</a>
                                                                </li>
                                                            @endforeach
                                                        </ul>
                                                    </div><!-- /.accordion-inner -->
                ...
                <div class='col-md-9'>
                    ...
                    <div id="category" class="category-carousel hidden-xs">
                        <div class="item">
                            <div class="image">
                                <img src="{{ asset('front') }}/assets/images/banners/cat-banner-1.jpg" alt=""
