...
(function (factory) {
    ...
    var dom = (function () {
        ...
        var isEmpty = function (node) {
            ...
            if (len === 0) {
                ...
                list.all(node.childNodes, isText) &&
                node.innerHTML === ""
            ) {
                // ex) <p></p>, <span></span>
                return true;
        ...
        var isCustomStyleTag = function (node) {
            return (
                node &&
                !dom.isText(node) &&
                list.contains(node.classList, "note-styletag")
            );
        };
        ...
        var Dropdown = function ($node, options) {
            ...
            this.show = function () {
                ...
                if (offset.left + width > windowWidth - bodyMarginRight) {
                    $dropdown.css(
                        "margin-left",
                        windowWidth - bodyMarginRight - (offset.left + width)
                    );
                } else {
    ...
    var dropdownCheck = renderer.create(
        '<div class="note-dropdown-menu note-check">',
        function ($node, options) {
            var markup = $.isArray(options.items)
                ? options.items.map(function (item) {
                      var value =
    ...
    var dialog = renderer.create(
        '<div class="note-modal" tabindex="-1"/>',
        function ($node, options) {
            if (options.fade) {
                $node.addClass("fade");
            }
    ...
    var key = (function () {
        ...
        return {
            ...
            isMove: function (keyCode) {
                return list.contains(
                    [keyMap.LEFT, keyMap.UP, keyMap.RIGHT, keyMap.DOWN],
                    keyCode
                );
            },
            /**
        ...
        var pointToTextRange = function (point) {
            var textRangeInfo = function (container, offset) {
                ...
                if (dom.isText(container)) {
                    ...
                    var prevContainer =
                        list.last(prevTextNodes).previousSibling;
                    node = prevContainer || container.parentNode;
                    offset += list.sum(
                        list.tail(prevTextNodes),
                        dom.nodeLength
                    );
        ...
        var WrappedRange = function (sc, so, ec, eo) {
            ...
            this.paraBookmark = function (paras) {
                return {
                    s: {
                        path: list.tail(
                            dom.makeOffsetPath(list.head(paras), sc)
                        ),
                        offset: so,
                    },
                    e: {
                        path: list.tail(
                            dom.makeOffsetPath(list.last(paras), ec)
                        ),
                        offset: eo,
                    },
                };
    ...
    var Style = function () {
        ...
        this.current = function (rng) {
            ...
            if (!rng.isOnList()) {
                ...
                var isUnordered =
                    $.inArray(styleInfo["list-style-type"], orderedTypes) > -1;
        ...
        this.addRow = function (rng, position) {
            ...
            if (position === "top") {
                ...
                if (cellHasRowspan) {
                    ...
                    $($(currentTr).parent().find("tr")[lastTrIndex]).after(
                        $(html)
                    );
                    return;
                }
    ...
    var Editor = function (context) {
        ...
        this.formatBlock = this.wrapCommand(function (tagName, $target) {
            var onApplyCustomStyle =
                context.options.callbacks.onApplyCustomStyle;
        ...
        context.memo(
            ...
            lang.help.insertHorizontalRule
        );
        ...
        this.removeBogus = function () {
            ...
            var textNode = list.find(
                list.from(bogusNode.childNodes),
                dom.isText
            );

            var bogusCharIdx = textNode.nodeValue.indexOf(
        ...
        this.insertTable = this.wrapCommand(function (dim) {
            ...
            rng.insertNode(
                table.createTable(dimension[0], dimension[1], options)
            );
        });
        ...
        this.isEmpty = function () {
            return (
                dom.isEmpty($editable[0]) || dom.emptyPara === $editable.html()
            );
        };
        ...
        this.pasteByEvent = function (event) {
            ...
            if (
                ...
                if (
                    ...
                    context.invoke("editor.insertImagesOrCallback", [
                        item.getAsFile(),
                    ]);
                }
    ...
    var Dropzone = function (context) {
        ...
        this.attachDragAndDropEvent = function () {
            ...
            $document
                .on("dragenter", documentEventHandlers.onDragenter)
    ...
    var Codeview = function (context) {
        ...
        this.deactivate = function () {
            ...
            var value =
                dom.value($codable, options.prettifyHtml) || dom.emptyPara;
    ...
    var Statusbar = function (context) {
        ...
        this.initialize = function () {
            ...
            $statusbar.on("mousedown", function (event) {
                ...
                var editableTop =
                    $editable.offset().top - $document.scrollTop();
                var onMouseMove = function (event) {
                    ...
                    height =
                        options.maxHeight > 0
                            ? Math.min(height, options.maxHeight)
                            : height;
    ...
    var Placeholder = function (context) {
        ...
        this.update = function () {
            var isShow =
                !context.invoke("codeview.isActivated") &&
                context.invoke("editor.isEmpty");
    ...
    var Buttons = function (context) {
        ...
        var invertedKeyMap = func.invertObject(
            options.keyMap[agent.isMac ? "mac" : "pc"]
        );

        var representShortcut = (this.representShortcut = function (
            editorMethod
        ) {
        ...
        this.isFontInstalled = function (name) {
            if (!self.fontInstalledMap.hasOwnProperty(name)) {
                self.fontInstalledMap[name] =
                    agent.isFontInstalled(name) ||
        ...
        this.addToolbarButtons = function () {
                        ...
                        ui.dropdown({
                            ...
                            template: function (item) {
                                if (typeof item === "string") {
                                    item = {
                                        tag: item,
                                        title: lang.style.hasOwnProperty(item)
                                            ? lang.style[item]
                                            : item,
                                    };
                                }
                            ...
                            click: context.createInvokeHandler(
                                "editor.formatBlock"
                            ),
                        }),
                    ])
            ...
            context.memo("button.bold", function () {
                return ui
                    .button({
                        ...
                        click: context.createInvokeHandlerAndUpdateState(
                            "editor.bold"
                        ),
                    })
                    .render();
            ...
            context.memo("button.clear", function () {
                return ui
                    .button({
                        ...
                        tooltip:
                            lang.font.clear + representShortcut("removeFormat"),
                        click: context.createInvokeHandler(
                            "editor.removeFormat"
                        ),
                    })
                ...
                return ui
                    .button({
                        ...
                        tooltip:
                            ...
                            representShortcut("strikethrough"),
                        click: context.createInvokeHandlerAndUpdateState(
                    ...
                    .buttonGroup({
                        ...
                        children: [
                            ui.button({
                                className: "note-current-color-button",
                                contents: ui.icon(
                                    options.icons.font + " note-recent-color"
                                ),
                ...
                return ui
                    .button({
                        ...
                        tooltip:
                            ...
                            representShortcut("insertUnorderedList"),
                        click: context.createInvokeHandler(
            ...
            context.memo("button.ol", function () {
                return ui
                    .button({
                        ...
                        tooltip:
                            lang.lists.ordered +
                            representShortcut("insertOrderedList"),
                        click: context.createInvokeHandler(
            ...
            var justifyCenter = ui.button({
                ...
                tooltip:
                    lang.paragraph.center + representShortcut("justifyCenter"),
            ...
            var justifyRight = ui.button({
                ...
                tooltip:
                    lang.paragraph.right + representShortcut("justifyRight"),
            ...
            var justifyFull = ui.button({
                ...
                tooltip:
                    lang.paragraph.justify + representShortcut("justifyFull"),
                ...
                return ui
                    .buttonGroup([
                        ui.button({
                            className: "dropdown-toggle",
                            contents: ui.dropdownButtonContents(
                                ui.icon(options.icons.alignLeft),
                                options
                            ),
                ...
                return ui
                    .buttonGroup([
                        ui.button({
                            className: "dropdown-toggle",
                            contents: ui.dropdownButtonContents(
                                ui.icon(options.icons.textHeight),
                                options
                            ),
                        ...
                        ],
                        {
                            callback: function ($node) {
                                ...
                                $catcher
                                    .css({
                                        width:
                                            options.insertTableMaxSize.col +
                                            "em",
                                        height:
                                            options.insertTableMaxSize.row +
                                            "em",
                                    })
                                    .mousedown(
                                        context.createInvokeHandler(
                                            "editor.insertTable"
                                        )
                                    )
            ...
            context.memo("button.link", function () {
                return ui
                    .button({
                        ...
                        tooltip:
                            lang.link.link +
                            representShortcut("linkDialog.show"),
            ...
            context.memo("button.hr", function () {
                return ui
                    .button({
                        ...
                        tooltip:
                            lang.hr.insert +
                            representShortcut("insertHorizontalRule"),
                        click: context.createInvokeHandler(
    ...
    var LinkDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            var body =
                ...
                (!options.disableLinkTarget
                    ...
                    : "");
            var footer =
                '<button href="#" class="btn btn-primary note-btn note-btn-primary ' +
        ...
        this.showLinkDialog = function (linkInfo) {
            return $.Deferred(function (deferred) {
                var $linkText = self.$dialog.find(".note-link-text"),
                    ...
                    $openInNewWindow = self.$dialog.find(
                        "input[type=checkbox]"
                    );
                ...
                ui.onDialogShown(self.$dialog, function () {
                    ...
                    var isChecked =
                        linkInfo.isNewWindow !== undefined
                            ...
                            : context.options.linkTargetBlank;
        ...
        context.memo(
            ...
            options.langInfo.help["linkDialog.show"]
        );
    };
    ...
    var ImageDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            if (options.maximumImageFileSize) {
                var unit = Math.floor(
                    Math.log(options.maximumImageFileSize) / Math.log(1024)
                );
                var readableSize =
                    (
                        options.maximumImageFileSize / Math.pow(1024, unit)
                    ).toFixed(2) *
                        1 +
                    " " +
                    " KMGTP"[unit] +
            ...
            var footer =
                '<button href="#" class="btn btn-primary note-btn note-btn-primary ' +
                'note-image-btn disabled" disabled>' +
                lang.image.insert +
                "</button>";
    ...
    var VideoDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            var footer =
                '<button href="#" class="btn btn-primary note-btn note-btn-primary ' +
                ' note-video-btn disabled" disabled>' +
                lang.video.insert +
                "</button>";
            ...
            return Object.keys(keyMap)
                .map(function (key) {
                    ...
                    $row.append(
                        ...
                        $("<span/>").html(
                            context.memo("help." + command) || command
                        )
                    );
                    return $row.html();
                })
    ...
    var AirPopover = function (context) {
        ...
        this.events = {
            ...
            "summernote.focusout": function (we, e) {
                ...
                if (
                    !e.relatedTarget ||
                    !dom.ancestor(e.relatedTarget, func.eq(self.$popover[0]))
                ) {
                    self.hide();
                }
            },
            ...
            if (
                ...
                if (hints.length && keyword) {
                    ...
                    var bnd = func.rect2bnd(
                        list.last(wordRange.getClientRects())
                    );
                    if (bnd) {
                        this.$popover.hide();
                        ...
                        hints.forEach(function (hint, idx) {
                            if (hint.match.test(keyword)) {
                                self.createGroup(idx, keyword).appendTo(
                                    self.$content
                                );
                            }
                        });
