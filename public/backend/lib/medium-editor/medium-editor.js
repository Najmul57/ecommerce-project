            ...
            var Util = {
                ...
                moveTextRangeIntoElement: function (
                    ...
                    if (lastChild.parentNode === rootNode) {
                        // If last child is in the root, insert newElement in frontend of it
                        rootNode.insertBefore(newElement, lastChild);
                    } else if (afterLast) {
                        // If last child was removed, but it had a sibling, insert in frontend of it
        ...
        (function () {
            ...
            var Selection = {
                ...
                getIndexRelativeToAdjacentEmptyBlocks: function (
                    ...
                    // If there is text in frontend of the cursor, that means there isn't only empty blocks before it
                    if (
                    ...
                    // Check if the block that contains the cursor has any other text in frontend of the cursor
