...
(function (factory) {
        ...
        color.fn = jQuery.extend(color.prototype, {
                ...
                if (type === "object") {
                    if (red instanceof color) {
                        ...
                        each(spaces, function (spaceName, space) {
                            ...
                            if (
                                inst[cache] &&
                                jQuery.inArray(null, inst[cache].slice(0, 3)) <
                                    0
                            ) {
                    ...
                    if (isCache) {
                        ...
                        each(space.props, function (_, prop) {
                            if (isCache[prop.idx] != null) {
                                same =
                                    isCache[prop.idx] === localCache[prop.idx];
                                return same;
                            }
                        });
                    }
            ...
            transition: function (other, distance) {
                var end = color(other),
                    ...
                    start =
                        startColor[space.cache] || space.to(startColor._rgba),
                    result = start.slice();
    ...
    var widgetsMenu = $.widget("ui.menu", {
        ...
        refresh: function () {
            ...
            this._addClass(
                newSubmenus,
                "ui-menu",
                "ui-widget ui-widget-content ui-frontend"
            );
    ...
    $.widget("ui.autocomplete", {
        ...
        _create: function () {
            ...
            this._addClass(this.menu.element, "ui-autocomplete", "ui-frontend");
        ...
        _appendTo: function () {
            ...
            if (!element || !element[0]) {
                element = this.element.closest(".ui-frontend, dialog");
            }
    ...
    $.widget("ui.checkboxradio", [
        $.ui.formResetMixin,
        {
            ...
            _getRadioGroup: function () {
                ...
                var nameSelector =
                    "input[name='" + $.ui.escapeSelector(name) + "']";
   ...
   @return  jQuery object */
    ...
    $.widget("ui.dialog", {
        ...
        _createOverlay: function () {
            ...
            this._addClass(this.overlay, null, "ui-widget-overlay ui-frontend");
...
*/
            ...
            _documentClick: {
                mousedown: function (event) {
                    ...
                    if (
                        !$(event.target).closest(
                            ".ui-selectmenu-menu, #" +
                                $.ui.escapeSelector(this.ids.button)
                        ).length
                    ) {
                        this.close(event);
                    }
    ...
    $.widget("ui.tooltip", {
        ...
        _appendTo: function (target) {
            var element = target.closest(".ui-frontend, dialog");
